...
/**
 * Externalised prompt-injection pattern catalogue for {@link BlockedPhraseGuardrail}.
 * Patterns are loaded from {@code app.security.injection-guard.patterns} in application.yml,
...
public class InjectionGuardProperties {
    ...
    /**
     * Regex patterns that trigger a block. Matched case-insensitively against the full user message.
     * Override via {@code app.security.injection-guard.patterns[0]=...} in application.yml.
     */
