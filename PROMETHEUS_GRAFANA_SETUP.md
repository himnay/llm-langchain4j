# <span style="color:hsl(46,80%,50%)">Observability Setup — Prometheus, Grafana, Tempo, Loki</span>
...
## <span style="color:hsl(184,80%,58%)">1. Start the stack</span>
...
## <span style="color:hsl(321,80%,58%)">2. Run the app</span>
...
## <span style="color:hsl(99,80%,58%)">3. Endpoints</span>
...
## <span style="color:hsl(236,80%,58%)">4. Grafana</span>
...
## <span style="color:hsl(14,80%,58%)">5. Tracing & log correlation</span>
...
## <span style="color:hsl(151,80%,58%)">Tuning</span>
